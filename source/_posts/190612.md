...
![QQ截图20190718120622.png](https://cdn.jsdelivr.net/gh/Anyway521/blogpic@main/image/imageQQ截图20190718120622.png)
...
![yiyan.png](https://cdn.jsdelivr.net/gh/Anyway521/blogpic@main/image/imageyiyan.png)
...
```
### 提交到百度资源搜索平台
[百度资源搜索平台](https://ziyuan.baidu.com/linksubmit/url)
需要添加网站，验证等，比较简单，过程不再赘述。
![20210209233914](https://cdn.jsdelivr.net/gh/Anyway521/blogpic2@main/image/20210209233914.png)
>建议你有自己域名的同学可以做一做，用Gitee page,Github page构建的博客好像无法被抓取。
## 3、添加百度统计
### 1、注册、获取统计代码：
[百度统计官网](https://tongji.baidu.com/)

![07.png](https://cdn.jsdelivr.net/gh/Anyway521/blogpic@main/image/image07.png)
