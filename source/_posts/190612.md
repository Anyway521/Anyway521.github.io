...
# 十二、修复代码块序号错乱问题
![20200414105555](https://cdn.anyway1314.cn/image20200414105555.png)

修改`yilia/source/main.xxxxx.css`,注释掉`white-space:pre-wrap;`

![20200414105801](https://cdn.anyway1314.cn/image20200414105801.png)
...
![20200414170533](https://cdn.anyway1314.cn/image20200414170533.png)
...
``` js
    <script>
        ...
        menu_icon[0]="<i class=\"fa fa-home\"></i> "
        menu_icon[1]="<i class=\"fa fa-book\"></i> "
        for (var i = 0; i < n; i++){
